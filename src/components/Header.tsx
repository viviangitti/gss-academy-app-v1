...
const BACK: Record<string, string | string[]> = {
  ...
  '/coach-voz': '/ia-coach',
  // Painel Controle
  '/condicoes': ['/', '/guia-marketing'],
  '/concorrencia': ['/', '/guia-marketing'],
  '/noticias': '/',
  '/follow-ups': '/',
  '/vendas': '/',
  '/feedback': '/',
  // Marketing (ferramentas — acessadas via Maestria/Guia)
  '/favoritos': '/',
  '/ofertas': '/',
  '/guia-marca': '/maestria',
  '/gerador-copy': '/maestria',
  '/marketing-chat': '/maestria',
  '/analise-campanha': '/raio-x-marketing',
  '/condicoes-admin': '/guia-marketing',
  '/concorrencia-admin': '/guia-marketing',
  '/ofertas-admin': '/',
  '/pos-campanha': '/',
  '/revisar-copy': '/',
  '/pre-lancamento': '/',
