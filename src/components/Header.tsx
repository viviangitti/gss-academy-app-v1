...
const BACK: Record<string, string | string[]> = {
  ...
  '/concorrencia': ['/', '/biblioteca', '/guia-marketing'],
  '/noticias': '/',
  '/follow-ups': '/',
  '/vendas': '/',
  '/feedback': '/',
  ...
  '/ofertas': '/biblioteca',
  '/guia-marca': ['/maestria', '/biblioteca', '/marketing-hub'],
  '/gerador-copy': ['/maestria', '/biblioteca', '/marketing-hub'],
  '/marketing-chat': ['/maestria', '/biblioteca', '/marketing-hub'],
  '/analise-campanha': ['/biblioteca', '/raio-x-marketing'],
  '/marketing-hub': '/biblioteca',
  '/condicoes-admin': ['/biblioteca', '/guia-marketing'],
