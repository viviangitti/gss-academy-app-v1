...
const MarketingRaioX = lazy(() => import('./pages/MarketingRaioX'));
      ...
      <div className="app">
        ...
        <main className="app-content">
          ...
          <Routes>
            ...
            <Route path="/raio-x-marketing" element={<MarketingRaioX />} />
...
const ROUTE_TITLES: Record<string, string> = {
  ...
  '/raio-x-marketing':  'GSS — Performance de Marketing',
  '/raio-x':            'GSS — Raio X',
  '/rescue':            'GSS — Resgate',
  '/meu-raiox':         'GSS — Meu Raio-X',
  '/mapa':              'GSS — Mapa do app',
  '/pre-reuniao':       'GSS — Pré-atendimento',
  '/coach-mensagem':    'GSS — Revisar Mensagem',
  '/analise-reuniao':   'GSS — Pós-atendimento',
